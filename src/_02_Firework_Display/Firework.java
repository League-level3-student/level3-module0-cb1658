...
public class Firework{
    ...
    public static final int sparkcount = 2000;
    ...
    public void drawSparks(Graphics g) {
    	...
    	for(int b = 0; b < sparkcount; b++) {
    		g.setColor(new Color(50,50,255,255));
    		g.fillOval(sparks[b].x,sparks[b].y,sparks[b].size,sparks[b].size);
    	}
